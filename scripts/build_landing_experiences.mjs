...
<link rel="canonical" href="${canonical}"><link rel="icon" href="https://jamesrealty.uk/favicon.svg" type="image/svg+xml"><link rel="preload" as="image" href="${image}" fetchpriority="high"><link rel="stylesheet" href="https://jamesrealty.uk/assets/landing-experience.css?v=6">
...
function renderV4(page) {
  ...
  return `${headV4(page)}<body class="theme-${page.theme}" data-page="${escapeHtml(page.title)}">${navV4(page)}<main id="content">${heroV4(page)}${proofV4(page)}${flow}${formV4(page)}${faqV4(page)}</main>${footerV4(page)}<script src="https://jamesrealty.uk/assets/landing-experience.js?v=6" defer></script></body></html>\n`;
}
